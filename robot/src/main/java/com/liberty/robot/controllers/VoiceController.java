...
public class VoiceController implements Runnable {
    ...
    private void startRecording(Handler handler) {
        try {
            ...
            System.out.println("[VoiceController] startRecording error : " + e.getMessage());
    ...
    private void initMicrophone() {
        ...
        try {
            ...
            System.out.println("[VoiceController] not correct : " + e.getMessage());
    ...
    private void initSpeakers() {
        try {
            ...
            System.out.println("[VoiceController] speakers initialized");
        } catch(Exception e) {
            System.err.println("[VoiceController] speakers init error : " + e.getMessage());
        }
    }
